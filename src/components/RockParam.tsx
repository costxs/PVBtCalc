...
export default function RockCard() {
    ...
    return (
        <div className="w- h-full bg-slate-400 rounded-sm px-[0.6vw] py-4 pt-1 flex flex-col items-center">
            <p className="uppercase font-bold text-[1.4vw]">Run Setup</p>
            ...
            <div className="w-full">
                <form action="" className="space-y-[0.8vw]">
                    <label htmlFor="" className="font-semibold">Rock Type</label>
                    <select name="" id="" className="rounded-sm font-semibold p-[0.4vw] py-[1.2vh] shadow-sm bg-gray-200 w-full" onChange={(e) => dispatch(setParameter({key:'rock_type',value:e.target.value}))} value={rockType}>
                        {
                    ...
                    <div className="flex flex-col">
                        ...
                        <input type="number" value={cLength} onChange={(e)=>dispatch(setParameter({key:'core_length',value:e.target.value}))} className="bg-slate-700 text-white p-[0.4vw] py-[1.2vh] w-full shadow-md rounded" placeholder="Inch"/>
                    </div>
                    <div className="flex flex-col">
                        <label htmlFor="" className="font-semibold">Core Diameter</label>
                        <input type="number" className="bg-slate-700 text-white p-[0.4vw] py-[1.2vh] w-full shadow-md rounded" value={cDiameter} onChange={(e)=>dispatch(setParameter({key:'core_diameter',value:e.target.value}))} placeholder="Inch"/>
                    </div>
                    <div className="flex flex-col">
                        <label htmlFor="" className="font-semibold">Core Porosity</label>
                        <input type="number" className="bg-slate-700 text-white p-[0.4vw] py-[1.2vh] w-full shadow-md rounded" value={cPorosity} onChange={(e)=>dispatch(setParameter({key:'core_porosity',value:e.target.value}))} placeholder="Fraction"/>
                    </div>
                </form>
            </div>
        </div>

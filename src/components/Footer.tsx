export default function FooterSection() {
  return (
    <footer style={{ gridColumn: '1 / -1', background: '#fff', borderTop: '1px solid var(--color-accent-300)', padding: '26px 30px 30px', display: 'flex', flexDirection: 'column', gap: '26px' }}>
      <div style={{ display: 'flex', gap: '10px', justifyContent: 'center', borderBottom: '1px solid var(--color-divider)', paddingBottom: '22px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gap: '30px' }}>
